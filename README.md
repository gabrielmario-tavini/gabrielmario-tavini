...
### Featured projects
- **Autonomous Mobile Manipulation (TIAGo, ROS2/Gazebo)** — full pipeline from SLAM mapping to ArUco-driven pick-and-place, every pose discovered at runtime, no hardcoded positions. [repo](https://github.com/gabrielmario-tavini/ros2-autonomous-robot-public)
